...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'mailtransaction');

		$('.daterangepicker_end_input').attr('data-grid', 'mailtransaction');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('mailtransaction', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
